                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="fa-icons">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#web-application" data-toggle="tab">Web-Application</a></li>
                                <li><a href="#hand" data-toggle="tab">hand</a></li>
                                <li><a href="#transportation" data-toggle="tab">transportation</a></li>
                                <li><a href="#gender" data-toggle="tab">gender</a></li>
                                <li><a href="#spinner" data-toggle="tab">spinner</a></li>
                                <li><a href="#form-control" data-toggle="tab">form-control</a></li>
                                <li><a href="#payment" data-toggle="tab">payment</a></li>
                                <li><a href="#chart" data-toggle="tab">chart</a></li>
                                <li><a href="#currency" data-toggle="tab">currency</a></li>
                                <li><a href="#text-editor" data-toggle="tab">text-editor</a></li>
                                <li><a href="#directional" data-toggle="tab">directional</a></li>
                                <li><a href="#video-player" data-toggle="tab">video-player</a></li>
                                <li><a href="#brand" data-toggle="tab">brand</a></li>
                                <li><a href="#medical" data-toggle="tab">medical</a></li>
                            </ul>
                            <div class="tab-content">
                                <section id="new" class="tab-pane active">
                                ...
                                <section id="web-application" class="tab-pane">
                                    <ul class="bs-glyphicons">
